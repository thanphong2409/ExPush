...
var app = {
    ...
    receivedEvent: function(id) {
		...
		pushNotification.register(app.successHandler, app.errorHandler,{"senderID":"666636108606","ecb":"app.onNotificationGCM"});
		if('android' === device.platform.toLowerCase()) {
			pushNotification.register(
				...
				}, 
				{
					...
					senderID : '666636108606'// Google Project ID.
				}
			);
		}
		else {// iOS.
			pushNotification.register(
				function(token) {
					$.ajax({
						url: "http://172.16.0.123/gcm_server_php/register.php",
						type: 'POST',
						data: 'name=PhoneGapiOS' + '&email=buituanphong24@gmail.com' + "&regId=" + token,
						success: function(data, textStatus, xhr) {
							alert('registration id = ' + e.regid);
						},
						error: function(xhr, textStatus, errorThrown) {
